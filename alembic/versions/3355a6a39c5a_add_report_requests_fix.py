"""Add-Report-Requests-Fix

Revision ID: 3355a6a39c5a
Revises: 8d27c14cb57c
Create Date: 2026-03-20 12:27:47.191611
...
revision: str = '3355a6a39c5a'
down_revision: Union[str, Sequence[str], None] = '8d27c14cb57c'
...
def upgrade() -> None:
    ...
    op.add_column('report_requests', sa.Column('response', sa.Text(), nullable=False))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('report_requests', 'response')
