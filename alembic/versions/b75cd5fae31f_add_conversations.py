...
Revision ID: b75cd5fae31f
Revises: 
Create Date: 2026-03-19 13:22:52.580075
...
def upgrade() -> None:
    ...
    op.add_column('conversations', sa.Column('modified_at', sa.DateTime(), nullable=False))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('conversations', sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False))
